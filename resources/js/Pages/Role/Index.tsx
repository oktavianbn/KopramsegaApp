                    ...
                    <div className="grid gap-2 lg:flex items-center justify-between mb-6">
                        <div className="flex gap-6 items-center">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <h2 className="text-base font-medium text-gray-700 whitespace-nowrap">Role / Daftar</h2>
                            </div>
                        </div>
                ...
                <div className="flex gap-4 mb-6 border-b">
                    ...
                    >
                        ...
                        <span className="ml-1 px-2 py-1 text-xs bg-gray-100 rounded-full">
                            {role.data.filter((d) => d.tipe === "m").length}
                        </span>
                    </button>
                    <button
                        onClick={() => handleTab("k")}
                    ...
                    >
                        Pengeluaran{" "}
                        <span className="ml-1 px-2 py-1 text-xs bg-gray-100 rounded-full">
                            {role.data.filter((d) => d.tipe === "k").length}
                        </span>
                    </button> */}
                </div>
                    ...
                    <div className="bg-white px-4 py-3 border-t border-gray-200 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            <span className="text-sm text-gray-700 whitespace-nowrap">
                                {role.from}-{role.to} dari{" "}
                                {role.total}
                            </span>
                            <div className="flex items-center gap-1">
                                <button
                                    className="p-2 rounded hover:bg-gray-100 disabled:opacity-50"
                                    disabled={role.current_page === 1}
                                    onClick={() =>
                                        router.get(
                                            "/role",
                                            {
