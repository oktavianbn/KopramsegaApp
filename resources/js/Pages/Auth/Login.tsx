                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700 p-8 ">
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div>
                                ...
                                />
                                <InputError message={errors.email} className="mt-2 text-sm text-red-600 dark:text-red-400" />
                            </div>
                            ...
                            <div>
                                ...
                                />
                                <InputError message={errors.password} className="mt-2 text-sm text-red-600 dark:text-red-400" />
                            </div>
