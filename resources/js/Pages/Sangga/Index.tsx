            ...
            <div className="min-h-screen bg-gray-50 p-6 overflow-hidden">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6 grid gap-2 lg:flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                        {/* Filter Dropdown: Semua / Dengan Logo / Tanpa Logo */}
                        ...
                        {/* Sorting is fixed to Nama Sangga (ascending) per request; UI removed */}
                    ...
                    <div className="bg-white px-4 py-3 border-t border-gray-200 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            <span className="text-sm text-gray-700 whitespace-nowrap">
                                {sangga.from}-{sangga.to} dari {sangga.total}
                            </span>
                            <div className="flex items-center gap-1">
                                <button
                                    className="p-2 rounded hover:bg-gray-100 disabled:opacity-50"
                                    disabled={sangga.current_page === 1}
                                    onClick={() =>
                                        router.get(
                                            "/sangga",
                                            {
                                ...
                                <button
                                    className="p-2 rounded hover:bg-gray-100 disabled:opacity-50"
                                    disabled={
                                        sangga.current_page === sangga.last_page
                                    }
                                    onClick={() =>
                                        router.get(
                                            "/sangga",
