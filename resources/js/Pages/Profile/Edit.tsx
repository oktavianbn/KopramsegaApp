                ...
                <div className="grid gap-2 md:flex items-center justify-between mb-6">
                    <div className="flex gap-6 items-center">
                        ...
                        <div className="flex flex-col gap-2">
                            <h1 className="text-2xl font-bold text-gray-700 whitespace-nowrap">Profile</h1>
                            <h2 className="text-base font-medium text-gray-700 whitespace-nowrap">Informasi Tentang Profile Akun Anda</h2>
                        </div>
                    </div>
                </div>
                    ...
                    <div className=" max-w-7xl space-y-6 ">
                        ...
                        <div className="grid grid-cols-3 gap-8">
                            <div className="bg-white dark:bg-gray-800 shadow rounded-2xl p-6 sm:p-8">
                                ...
                                <div className="mt-4">
                                    <h4 className="text-sm font-bold text-gray-700 dark:text-gray-300">Developer</h4>
